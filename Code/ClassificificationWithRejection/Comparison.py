...
# embedding features 
 ...
 #Saving results 
    ...
    #probability = True
    df = pd.DataFrame(data= {'ids': ids, 'train_1_test_0_ids': train_1_test_0_ids, 'true_labels':true_labels, 'predicted_labels_srnc': predicted_labels_srnc, 'predicted_labels_rejection': predicted_labels_rejection, 'predicted_labels_semi': predicted_labels_semi,
